...
import { HealthConditionsSidebar } from "./health-conditions-sidebar"
...
export const PatientHeader = ({
  ...
  const handleViewHealthConditions = () => {
    setIsHealthConditionsOpen(true)
  }

  const handleCloseHealthConditions = () => {
    setIsHealthConditionsOpen(false)
  }
          ...
          <div className="ml-8 pl-8 border-l border-gray-200 flex items-center divide-x divide-gray-200 ml-auto">
            ...
            <InfoCell label="Health Conditions">
              <div className="flex items-center gap-3">
                ...
                <button
                  type="button"
                  onClick={handleViewHealthConditions}
