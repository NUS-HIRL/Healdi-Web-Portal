...
export default function AiExerciseRecommendations({ patientId }: { patientId: string }) {
    ...
    function handleEdit(exerciseId: string) {
        router.push(`/patient-info/${patientId}/ai-exercise-recommendation/edit/${exerciseId}`);
    }
