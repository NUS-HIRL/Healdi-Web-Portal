...
export const EditAllergiesPage = () => {
  const [items, setItems] = useState<AllergyItem[]>([
    ...
    { id: 'a2', title: 'Repaglinide', reactions: ['Dizziness', 'Others'], other: '' },
  ...
  const updateReactions = (id: string, reactions: Reaction[]) =>
    setItems(prev =>
      prev.map(i => (i.id === id ? { ...i, reactions, other: reactions.includes('Others') ? i.other ?? '' : undefined } : i)),
    )
      ...
      <div className="flex-1 flex flex-col">        
        ...
        <main className="flex-1 overflow-auto">
          <div className="px-6 py-4">
            <nav className="text-sm text-gray-500">Home / Select Patient / Edit Allergies</nav>
          </div>
          ...
          <div className="px-6 pb-4 flex items-center justify-between">
            ...
            <h1 className="text-3xl font-bold text-gray-900">Edit Allergies</h1>
            </div>
          ...
          <div className="px-6 pt-4 pb-6 bg-white">
            <div className="w-full">
              <div className="mb-6">
                <h2 className="text-xl font-semibold text-gray-900">Allergies List</h2>
              </div>
              ...
              {items.map((row, idx) => (
                <div key={row.id} className="relative">
                  ...
                  {idx !== 0 && <div className="my-8 border-t border-gray-200" />}
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start mt-6">
                    <div className="md:col-span-1">
                      ...
                      <p className="text-sm text-gray-500 mt-1">List any known allergies.</p>
                    </div>
                    <div className="md:col-span-2">
                      <MultiSelect
                        value={row.reactions}
                  ...
                  {row.reactions.includes('Others') && (
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-start mt-6">
                      <div className="md:col-span-1">
                        <Label className="text-sm font-semibold text-gray-700">Other Allergy</Label>
                        <p className="text-sm text-gray-500 mt-1">
              ...
              <div className="bg-gray-100 rounded-lg p-6 mt-10">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  Review the details and make sure everything is accurate. Click Submit to save changes.
                </p>
